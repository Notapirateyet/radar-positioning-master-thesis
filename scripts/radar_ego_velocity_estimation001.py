...
def estimate_ownship_velocity(points: List[Point], speeds: np.array) -> np.array:
...
def create_odom_and_pub(velocities, pub):
...
def pc2_callback(msg: PointCloud2, pub: rospy.Publisher):
    ...
    ownship_velocity = estimate_ownship_velocity(points, velocities)
    # rospy.loginfo(ownship_velocity)
